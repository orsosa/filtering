...
import subprocess
############## global setting ###########
outdir="/volatile/clas12/users/osoto/data/mix/RGA/trains/pass1/v1_4"
app="/home/osoto/Clas12AnaHipo4/examples/particle_mix_tree"
script="/home/osoto/dihadron/filtering/runscripts/run_mix_pipaa.sh"
WF="pipaa_dstRGA_OB"
DEBUG=False
track="analysis"
...
def main():
    global WF
    create_wf()
    flist = import_flist("filelist/rga_OB_evdata_pass1_v1_4.txt")
    c=0
    for fn in flist:
        add_job(fn,WF,c)
        c = c+1
